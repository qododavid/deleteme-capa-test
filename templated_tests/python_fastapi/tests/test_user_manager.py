...
class TestUserManager:
    ...
    def test_update_existing_user(self, user_manager, valid_user_data):
        user_manager.create_user(**valid_user_data)
        updated_user = user_manager.update_user(valid_user_data["username"], full_name="Updated Name", email="updated@example.com")
    ...
    def test_get_user_existing(self, user_manager, valid_user_data):
        user_manager.create_user(**valid_user_data)
        user = user_manager.get_user(valid_user_data["username"])
        assert user is not None
        assert user.username == valid_user_data["username"]
